        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    <h1>NF-e A1</h1>
                    <p>Software, Certificado Digital Nota Fiscal Eletrônica do tipo A1</p>
                </div>
            </div>
            <!--TXT-->
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Escolha a Validade</h5>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01MPJA1SO12_Software">
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano - <?= precoFinal(348) ?>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    ...
                    <p>(Requer Mídia Compatível) Certificado Digital, Nota Fiscal Eletrônica do tipo A3 </p>
                </div>
            </div>
            <!--TXT-->
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01MPJA3SE12_Certificado Digital">
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano - <?= precoFinal(348) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01MPJA3SE36_Certificado Digital">
                                3 anos - <?= precoFinal(556) ?>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    ...
                    <p>Cartão Inteligente, Certificado Digital Nota Fiscal Eletrônica do tipo A3</p>
                </div>
            </div>
            <!--TXT-->
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01MPJA3SC12_Cartão Inteligente">
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano - <?= precoFinal(460) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01MPJA3SC36_Cartão Inteligente">
                                3 anos - <?= precoFinal(605) ?>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    ...
                    <p>Cartão Inteligente + Leitora, Certificado Digital Nota Fiscal Eletrônica do tipo A3</p>
                </div>
            </div>
            <!--TXT-->
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01MPJA3SL12_Cartão Inteligente + Leitora">
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano - <?= precoFinal(589) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01MPJA3SL36_Cartão Inteligente + Leitora">
                                3 anos - <?= precoFinal(770) ?>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    <h1>NF-e A3</h1>
                    <h4>Somente Token</h4>
                    <p>Token, Certificado DigitalNota Fiscal Eletrônica do tipo A3</p>
                </div>
            </div>
            <!--TXT-->
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01MPJA3TO12_Token">
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano - <?= precoFinal(589) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01MPJA3TO36_Token" required>
                                3 anos - <?= precoFinal(770) ?>
                            </label>
                        </div>
                    </div>
