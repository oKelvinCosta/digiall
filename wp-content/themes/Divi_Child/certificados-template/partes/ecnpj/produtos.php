        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    <h1>e-CNPJ A1</h1>
                    <p>Software Certificado Digital do tipo A1 para Pessoa Jurídica (PJ) com validade de 1
                        ano.</p>
                </div>
            </div>
            <!--TXT-->
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA1SO12_Software"  >
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano - <?= precoFinal(190) ?>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    ...
                    <p>(Requer Mídia Compatível) Certificado Digital do tipo A3 para Pessoa Jurídica (PJ) com validade de 1
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3SE12_Certificado Digital" >
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano - <?= precoFinal(200) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3SE24_Certificado Digital" >
                                2 anos - <?= precoFinal(220) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3SE36_Certificado Digital" >
                                3 anos - <?= precoFinal(250) ?>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    ...
                    <p>Cartão Inteligente, Certificado Digital do tipo A3 para Pessoa Jurídica (PJ) com validade de 1
                        ano, 2 anos ou 3 anos.</p>
                </div>
            </div>
            <!--TXT-->
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3SC12_Certificado Inteligente" >
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano - <?= precoFinal(205) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3SC24_Cartão Inteligente" >
                                2 anos - <?= precoFinal(260) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3SC36_Cartão Inteligente" >
                                3 anos - <?= precoFinal(295) ?>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    ...
                    <p>Cartão Inteligente + Leitora, Certificado Digital do tipo A3 para Pessoa Jurídica (PJ) com validade de 1
                        ano, 2 anos ou 3 anos.</p>
                </div>
            </div>
            <!--TXT-->
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3SL12_Cartão Inteligente + Leitora" >
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano - <?= precoFinal(265) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3SL24_Cartão Inteligente + Leitora" >
                                2 anos - <?= precoFinal(329) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3SL36_Cartão Inteligente + Leitora" >
                                3 anos - <?= precoFinal(370) ?>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    <h1>e-CNPJ A3</h1>
                    <h4>Somente Token</h4>
                    <p>Token, Certificado Digital do tipo A3 para Pessoa Jurídica (PJ) com validade de 1
                        ano, 2 anos ou 3 anos.</p>
                </div>
            </div>
            <!--TXT-->
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3TO12_Token" >
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano - <?= precoFinal(265) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3TO24_Token" >
                                2 anos - <?= precoFinal(329) ?>
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C01RPJA3TO36_Token"  required>
                                3 anos - <?= precoFinal(360) ?>
                            </label>
                        </div>
                    </div>
                </div>
...
<div class="row voffset produto">
    ...
    <div class="col-sm-6 col-md-4">
      <div class="svg_img">
          ...
          <svg aria-hidden="true" data-prefix="fal" data-icon="file-certificate" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-file-certificate fa-w-16 fa-9x">
              <path fill="currentColor" d="M497.9 97.98L414.02 14.1c-9-9-21.19-14.1-33.89-14.1H176c-26.5.1-47.99 21.6-47.99 48.09V165.7c-5.97 0-11.94-1.68-24.13-5.03-1.7-.46-3.36-.66-4.96-.66-5.56 0-10.43 2.5-13.66 5.79-17.95 18.26-17.07 17.77-41.7 24.5-6.7 1.81-11.97 7.21-13.78 14.07-6.47 24.67-6.09 24.16-24.02 42.32-4.95 5.04-6.9 12.48-5.08 19.43 6.56 24.38 6.52 24.39 0 48.76-1.82 6.95.12 14.4 5.08 19.45 18 18.15 17.58 17.79 24.02 42.29 1.8 6.88 7.08 12.27 13.78 14.1 1.8.48 2.92.8 4.46 1.21V496c0 5.55 2.87 10.69 7.59 13.61 4.66 2.91 10.59 3.16 15.56.7l56.84-28.42 56.84 28.42c2.25 1.12 4.72 1.69 7.16 1.69h272c26.49 0 47.99-21.5 47.99-47.99V131.97c0-12.69-5.1-24.99-14.1-33.99zM384.03 32.59c2.8.7 5.3 2.1 7.4 4.2l83.88 83.88c2.1 2.1 3.5 4.6 4.2 7.4h-95.48V32.59zM33.28 316.68c5.7-22.3 5.7-30.23.01-52.39 15.65-16.2 19.56-22.98 25.63-45.06 21.57-6.13 28.06-9.92 43.88-25.69 9.8 2.62 16.82 4.15 25.21 4.15 8.28 0 15.25-1.49 25.19-4.16 15.56 15.51 22.49 19.58 43.86 25.68 5.98 21.95 9.71 28.63 25.65 45.07-5.77 22.45-5.76 30 0 52.4-15.62 16.17-19.55 22.96-25.61 44.96-14.63 3.92-24 7.36-37.25 19.36-9.94-4.53-20.78-6.89-31.85-6.89s-21.9 2.36-31.85 6.9c-13.18-11.88-22.56-15.34-37.23-19.33-5.97-21.89-9.72-28.57-25.64-45zm101.89 133.01c-4.5-2.25-9.81-2.25-14.31 0l-40.84 20.42V409.9c.12.12.19.17.31.29 3.75 3.82 8.68 5.79 13.64 5.79 3.5 0 7.02-.98 10.16-2.97 7.25-4.59 15.56-6.88 23.87-6.88s16.62 2.29 23.87 6.86c3.16 2.02 6.68 3.01 10.17 3.01 4.96 0 9.87-1.99 13.63-5.79.13-.13.21-.18.34-.32v60.22l-40.84-20.42zm344.84 14.32c0 8.8-7.2 16-16 16h-256V391.9c1.54-.4 2.65-.71 4.44-1.19 6.7-1.82 11.97-7.22 13.77-14.08 6.47-24.68 6.09-24.16 24.03-42.32 4.95-5.04 6.9-12.49 5.07-19.44-6.53-24.33-6.55-24.34 0-48.76 1.83-6.95-.12-14.4-5.07-19.45-18-18.15-17.58-17.79-24.03-42.29-1.8-6.87-7.07-12.27-13.75-14.09-24.23-6.57-23.89-6.23-41.72-24.52-2.94-2.97-6.78-4.52-10.74-5.16V48.09c0-8.8 7.2-16.09 16-16.09h176.03v104.07c0 13.3 10.7 23.93 24 23.93h103.98v304.01z" class=""></path>
          </svg>
    ...
    <div class="col-sm-6 col-md-8">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="et_pb_text_inner">
                    <h1>e-CNPJ ME, EPP E MEI</h1>
                    <h4>Somente Certificado</h4>
                    <p>O e-CNPJ (versão eletrônica do CNPJ) Empreendedor ME, EPP e MEI é um certificado digital ICP-Brasil exclusivo para Empreendedores e empresários das Micro (ME), Empresas de Pequeno Porte (EPP) e Microempreendedor Individual (MEI).</p>
                </div>
            </div>
            <!--TXT-->
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C91RPJA3SE18_Certificado e-CNPJ ME, EPP E MEI">
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano e 6 meses - <?= precoFinal(189) ?>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C91RPJA3SL18_Leitora + Cartão" >
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano e 6 meses - <?= precoFinal(219) ?>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class=" col-sm-12 col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="product_code" value="C91RPJA3TO18_Token" >
                                <span class="special-tag-for-editing-text-with-html"></span>
                                1 ano e 6 meses - <?= precoFinal(219) ?>
                            </label>
                        </div>
