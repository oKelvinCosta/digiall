...
// Template Name: Template Certificados e-CNPJ, ME, EPP e MEI


// Descricao
// Página de Template ECNPJ - Empresa
...
$api = new GerenciadorCertificados('ecnpj', $_POST);
        ...
        <div class="et_builder_inner_content et_pb_gutters3">
                    ...
                    <div class="et_pb_column et_pb_column_4_4 et_pb_column_0    et_pb_css_mix_blend_mode_passthrough et-last-child">
                        ...
                        <div class="et_pb_module et_pb_text et_pb_text_0 et_pb_bg_layout_dark  et_pb_text_align_center"
                            ...
                            <div class="et_pb_text_inner">
                                <h1>E-CNPJ</h1>
                                <p>O e-CNPJ é um certificado digital ICP-Brasil que identifica uma pessoa jurídica, de
                                    forma unívoca, e permite a realização de transações eletrônicas seguras nos meios
                                    virtuais. Também há o exclusivo para Empreendedores e empresários das Micro (ME),
                                    Empresas de Pequeno Porte (EPP) e Microempreendedor Individual (MEI).
                                </p>
                            </div>
            ...
            <div class="et_pb_section et_pb_section_3 et_pb_with_background et_section_regular">
                <div class="et_pb_row et_pb_row_1 et_pb_row_fullwidth">
                    ...
                    <form class="needs-validation form_certificado" id="ecnpj_form" method="post"
                          action="<?= get_permalink() . '#ancora_pos_envio' ?>"
                          enctype="multipart/form-data">


                        <?php
                        require "partes/ecnpj/produtos.php";
                        ?>
