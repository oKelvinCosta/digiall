...
?>
    ...
    <?php
    // Kelvin
    // Se for da parte que vende certificados, carrega o css custom
    global $template;
    if (strpos($template, 'ecpf.php') OR strpos($template, 'ecnpj.php') OR strpos($template, 'nfe.php') OR is_page(438)) {
        ?>
        <link rel="stylesheet" href="<?= get_stylesheet_directory_uri()  ?>/certificados-template/css/bootstrap.min.css">
        <link rel="stylesheet" href="<?= get_stylesheet_directory_uri()  ?>/certificados-template/css/bootstrap-grid.min.css">
        <link rel="stylesheet" href="<?= get_stylesheet_directory_uri()  ?>/certificados-template/css/certificados-template.css">
        <?php
    }
    // Kelvin
    ?>
